  ...
  return (
    <div className="min-h-screen bg-[#050510] flex overflow-hidden">
      ...
      <div className="hidden lg:flex lg:w-[45%] relative flex-col justify-between p-12 overflow-hidden">
        <div className="absolute inset-0 bg-gradient-to-br from-purple-900/60 via-violet-950/80 to-[#050510]" />
        ...
        <div className="relative z-10">
          ...
          <p className="text-white/50 text-base mb-10 leading-relaxed">
            Build and publish a complete website in minutes — just describe your business.
          </p>
